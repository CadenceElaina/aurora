...
const DIFF_TOTALS = { easy: 15, medium: 35, hard: 0 };
...
/* Fall 2026 semester: Aug 19 → Dec 11 (114 days). Frames simulate progression through the semester. */
          ...
          >
            ...
            <section className="rounded-lg border border-border bg-muted p-3 mb-2">
              ...
              <div className="h-2.5 rounded-full bg-background overflow-hidden flex">
                <div className="bg-green-500 transition-all duration-700" style={{ width: `${(t.mastered / 50) * 100}%` }} />
                <div className="bg-blue-500 transition-all duration-700" style={{ width: `${(t.learning / 50) * 100}%` }} />
              </div>
              <div className="flex gap-4 mt-1.5 text-xs text-muted-foreground">
                <span className="transition-all duration-500">
                  <span className="inline-block w-2 h-2 rounded-full bg-green-500 mr-1" />
                  {t.mastered} Mastered ({Math.round((t.mastered / 50) * 100)}%)
                </span>
                <span className="transition-all duration-500">
